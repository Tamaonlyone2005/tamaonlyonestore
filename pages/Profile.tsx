...
import { Save, Lock, User as UserIcon, Shield, Coins, Eye, EyeOff, Share2, BadgeCheck, Crown, Download, Upload, Receipt, Heart, Activity, Image as ImageIcon, Loader2, Store, Trash2, Camera, LogOut } from 'lucide-react';
...
const Profile: React.FC<ProfileProps> = ({ user }) => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'orders' | 'wishlist' | 'points' | 'activity'>('overview');
